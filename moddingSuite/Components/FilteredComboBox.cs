...
namespace moddingSuite.Components
{
    ...
    {  
        ...
        protected override void OnItemsSourceChanged(IEnumerable oldValue, IEnumerable newValue)
        {
            if (newValue != null)
            {
                ListCollectionView view = (ListCollectionView)CollectionViewSource.GetDefaultView(newValue);
...

        {
            if (this.ItemsSource != null)
            {
                ...
                this.EditableTextBox.CaretIndex = int.MaxValue;
            }
        }
        /// <summary>
        /// Clear the Filter.
        ...
        private bool FilterPredicate(object value)
        {
            ...
            if (value.ToString().Contains(this.currentFilter, StringComparison.CurrentCultureIgnoreCase))
            {
              return true;
            }
            return false;
